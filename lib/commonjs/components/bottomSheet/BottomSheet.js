...
const BottomSheetComponent = /*#__PURE__*/(0, _react.forwardRef)(function BottomSheet(props, ref) {
  ...
  (0, _reactNativeReanimated.useAnimatedReaction)(() => ({
    ...
    if (animatedAnimationState.value === _constants.ANIMATION_STATE.RUNNING) {
      nextPosition = animatedNextPositionIndex.value !== -1 ? snapPoints[animatedNextPositionIndex.value] : animatedCurrentIndex.value !== -1 ? animatedNextPosition.value : animatedClosedPosition.value;
